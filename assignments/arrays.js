...
console.log(
  `Car 33 is a ${inventory[33 - 1].car_make} ${inventory[33 - 1].car_model} ${inventory[33 - 1].car_year}`
);
...
console.log(
  `Last Car in the inventory is ${inventory[lastCar].car_make} ${inventory[lastCar].car_model}`
);
